...
function changeToRow() {
    r2.innerHTML = `<div class="r2a">
                        <img src="/svg/flex-wrap/flex-nowrap.svg" class="svg-img flex-nowrap">
    ...
    r3.innerHTML = `<div class="r3a">
                        <img src="/svg/align-content/flex-center.svg" class="svg-img flex-center">
                        <p class="flowing-name7">Add align-content: center;</p>
                    </div>
                    <div class="r3b">
                        <img src="/svg/align-content/flex-start.svg" class="svg-img flex-start">
                        <p class="flowing-name8">Add align-content: flex-start;</p>
                    </div>
                    <div class="r3c">
                        <img src="/svg/align-content/flex-end.svg" class="svg-img flex-end">
                        <p class="flowing-name9">Add align-content: flex-end;</p>
                    </div>
                    <div class="r3d">
                        <img src="/svg/align-content/flex-space-around.svg" class="svg-img flex-space-around">
                        <p class="flowing-name10">Add align-content: space-around;</p>
                    </div>
                    <div class="r3e">
                        <img src="/svg/align-content/flex-space-between.svg" class="svg-img flex-space-between">
                        <p class="flowing-name11">Add align-content: space-between;</p>
                    </div>
                    <div class="r3f">
                        <img src="/svg/align-content/flex-stretch.svg" class="svg-img flex-stretch">
                        <p class="flowing-name12">Add align-content: stretch;</p>
                    </div>`;
    r4.innerHTML = `<div class="r4a">
                        <img src="/svg/align-content/flex-center-2.svg" class="svg-img flex-center-2">
                        <p class="flowing-name13">Add justify-content: center;</p>
                    </div>
                    <div class="r4b">
                        <img src="/svg/align-content/flex-start-2.svg" class="svg-img flex-start-2">
                        <p class="flowing-name14">Add justify-content: flex-start;</p>
                    </div>
                    <div class="r4c">
                        <img src="/svg/align-content/flex-end-2.svg" class="svg-img flex-end-2">
                        <p class="flowing-name15">Add justify-content: flex-end;</p>
                    </div>
                    <div class="r4d">
                        <img src="/svg/align-content/flex-space-between-2.svg" class="svg-img flex-space-between-2">
                        <p class="flowing-name16">Add justify-content: space-between;</p>
                    </div>
                    <div class="r4e">
                        <img src="/svg/align-content/flex-space-around-2.svg" class="svg-img flex-space-around-2">
                        <p class="flowing-name17">Add justify-content: space-around;</p>
                    </div>
                    <div class="r4f">
                        <img src="/svg/justify-content/flex-space-evenly.svg" class="svg-img flex-space-evenly">
                        <p class="flowing-name18">Add justify-content: space-evenly;</p>
                    </div>`;
    r5.innerHTML = `<div class="r5a">
                    <img src="/svg/align-items/align-items-center.svg" class="svg-img align-items-center">
                        <p class="flowing-name19">Add align-items: center;</p>
                    </div>
                    <div class="r5b">
                    <img src="/svg/align-items/align-items-flex-start.svg" class="svg-img align-items-flex-start">
                        <p class="flowing-name20">Add align-items: flex-start;</p>
                    </div>
                    <div class="r5c">
                    <img src="/svg/align-items/align-items-flex-end.svg" class="svg-img align-items-flex-end">
                        <p class="flowing-name21">Add align-items: flex-end;</p>
                    </div>
                    <div class="r5d">
                    <img src="/svg/align-items/align-items-stretch.svg" class="svg-img align-items-stretch">
                        <p class="flowing-name22">Add align-items: stretch;</p>
                    </div>
                    <div class="r5e">
                    <img src="/svg/align-items/align-items-baseline.svg" class="svg-img align-items-baseline">
                        <p class="flowing-name23">Add align-items: baseline;</p>
                    </div>`;
    row6.innerHTML =    `<div class="r6a">
                            <img src="/svg/align-self/self-center.svg" class="svg-img align-self-center">
                            <p class="flowing-name24">Add align-self: center;</p>
                        </div>
                        <div class="r6b">
                            <img src="/svg/align-self/self-start.svg" class="svg-img align-self-start">
                            <p class="flowing-name25">Add align-self: self-start;</p>
                        </div>
                        <div class="r6c">
                            <img src="/svg/align-self/self-end.svg" class="svg-img align-self-end">
                            <p class="flowing-name26">Add align-self: self-end;</p>
                        </div>
                        <div class="r6d">
                            <img src="/svg/align-self/self-stretch.svg" class="svg-img align-self-stretch">
                            <p class="flowing-name27">Add align-self: stretch;</p>
                        </div>
                        <div class="r6e">
                            <img src="/svg/align-items/align-items-baseline.svg" class="svg-img align-self-baseline">
...
function changeToColumn() {
    r2.innerHTML = `<div class="r2a">
                        <img src="/svg/flex-wrap/flex-nowrap-reverse.svg" class="svg-img flex-nowrap">
                        <p class="flowing-name5">Add flex-direction: nowrap;</p>
                    </div>
                    <div class="r2b">
    ...
    r3.innerHTML = `<div class="r3a">
                        <img src="/svg/align-content/flex-center-2.svg" class="svg-img flex-center">
                        <p class="flowing-name7">Add align-content: center;</p>
                    </div>
                    <div class="r3b">
                        <img src="/svg/align-content/flex-start-2.svg" class="svg-img flex-start">
                        <p class="flowing-name8">Add align-content: flex-start;</p>
                    </div>
                    <div class="r3c">
                        <img src="/svg/align-content/flex-end-2.svg" class="svg-img flex-end">
                        <p class="flowing-name9">Add align-content: flex-end;</p>
                    </div>
                    <div class="r3d">
                        <img src="/svg/align-content/flex-space-around-2.svg" class="svg-img flex-space-around">
                        <p class="flowing-name10">Add align-content: space-around;</p>
                    </div>
                    <div class="r3e">
                        <img src="/svg/align-content/flex-space-between-2.svg" class="svg-img flex-space-between">
                        <p class="flowing-name11">Add align-content: space-between;</p>
                    </div>
                    <div class="r3f">
                        <img src="/svg/align-content/flex-stretch-2.svg" class="svg-img flex-stretch">
                        <p class="flowing-name12">Add align-content: stretch;</p>
                    </div>`;
    r4.innerHTML = `<div class="r4a">
                        <img src="/svg/align-content/flex-center.svg" class="svg-img flex-center-2">
                        <p class="flowing-name13">Add justify-content: center;</p>
                    </div>
                    <div class="r4b">
                        <img src="/svg/align-content/flex-start.svg" class="svg-img flex-start-2">
                        <p class="flowing-name14">Add justify-content: flex-start;</p>
                    </div>
                    <div class="r4c">
                        <img src="/svg/align-content/flex-end.svg" class="svg-img flex-end-2">
                        <p class="flowing-name15">Add justify-content: flex-end;</p>
                    </div>
                    <div class="r4d">
                        <img src="/svg/align-content/flex-space-between.svg" class="svg-img flex-space-between-2">
                        <p class="flowing-name16">Add justify-content: space-between;</p>
                    </div>
                    <div class="r4e">
                        <img src="/svg/align-content/flex-space-around.svg" class="svg-img flex-space-around-2">
                        <p class="flowing-name17">Add justify-content: space-around;</p>
                    </div>
                    <div class="r4f">
                        <img src="/svg/justify-content/flex-space-evenly-2.svg" class="svg-img flex-space-evenly">
                        <p class="flowing-name18">Add justify-content: space-evenly;</p>
                    </div>`;
    r5.innerHTML = `<div class="r5a">
                    <img src="/svg/align-items/align-items-center-column.svg" class="svg-img align-items-center">
                        <p class="flowing-name19">Add align-items: center;</p>
                    </div>
                    <div class="r5b">
                    <img src="/svg/align-items/align-items-flex-start-column.svg" class="svg-img align-items-flex-start">
                        <p class="flowing-name20">Add align-items: flex-start;</p>
                    </div>
                    <div class="r5c">
                    <img src="/svg/align-items/align-items-flex-end-column.svg" class="svg-img align-items-flex-end">
                        <p class="flowing-name21">Add align-items: flex-end;</p>
                    </div>
                    <div class="r5d">
                    <img src="/svg/align-items/align-items-stretch-column.svg" class="svg-img align-items-stretch">
                        <p class="flowing-name22">Add align-items: stretch;</p>
                    </div>
                    <div class="r5e">
                    <img src="/svg/align-items/align-items-baseline.svg" class="svg-img align-items-baseline">
    ...
    row6.innerHTML =    `<div class="r6a">
                            <img src="/svg/align-self/self-center-column.svg" class="svg-img align-self-center">
                            <p class="flowing-name24">Add align-self: center;</p>
                        </div>
                        <div class="r6b">
                            <img src="/svg/align-self/self-flex-start.svg" class="svg-img align-self-start">
                            <p class="flowing-name25">Add align-self: self-start;</p>
                        </div>
                        <div class="r6c">
                            <img src="/svg/align-self/self-flex-end.svg" class="svg-img align-self-end">
                            <p class="flowing-name26">Add align-self: self-end;</p>
                        </div>
                        <div class="r6d">
                            <img src="/svg/align-self/self-stretch-column.svg" class="svg-img align-self-stretch">
                            <p class="flowing-name27">Add align-self: stretch;</p>
                        </div>
                        <div class="r6e">
                            <img src="/svg/align-items/align-items-baseline.svg" class="svg-img align-self-baseline">
...
function changeToRowReverse() {
    ...
    r4.innerHTML = `<div class="r4a">
                    ...
                    <div class="r4b">
                        <img src="/svg/align-content/flex-end-2.svg" class="svg-img flex-start-2">
                        <p class="flowing-name14">Add justify-content: flex-start;</p>
                    </div>
                    <div class="r4c">
                        <img src="/svg/align-content/flex-start-2.svg" class="svg-img flex-end-2">
                        <p class="flowing-name15">Add justify-content: flex-end;</p>
                    </div>
                    <div class="r4d">
                        <img src="/svg/align-content/flex-space-between-2.svg" class="svg-img flex-space-between-2">
...
function changeToColumnReverse() {
    ...
    r4.innerHTML = `<div class="r4a">
                    ...
                    <div class="r4b">
                        <img src="/svg/align-content/flex-end.svg" class="svg-img flex-start-2">
                        <p class="flowing-name14">Add justify-content: flex-start;</p>
                    </div>
                    <div class="r4c">
                        <img src="/svg/align-content/flex-start.svg" class="svg-img flex-end-2">
                        <p class="flowing-name15">Add justify-content: flex-end;</p>
                    </div>
                    <div class="r4d">
                        <img src="/svg/align-content/flex-space-between.svg" class="svg-img flex-space-between-2">
